...
describe('FilterBar Component', () => {
  ...
  describe('initial render', () => {
    test('renders with default props', () => {
      ...
      expect(screen.getByPlaceholderText('Search baby items...')).toBeInTheDocument()
    ...
    test('renders with custom itemCount and activeFiltersCount', () => {
      ...
      expect(screen.getByText('25 results · Price: High to Low')).toBeInTheDocument()
  ...
  describe('filter dropdowns', () => {
    ...
    test('renders all category options', () => {
      ...
      expect(categorySelect).toContainHTML('<option value="Other">Other</option>')
    })
    ...
    test('renders all condition options', () => {
      ...
      expect(conditionSelect).toContainHTML('<option value="">Any Condition</option>')
    ...
    test('renders all sort options', () => {
      ...
      expect(sortSelect).toContainHTML('<option value="newest">Newest First</option>')
      expect(sortSelect).toContainHTML('<option value="oldest">Oldest First</option>')
      expect(sortSelect).toContainHTML('<option value="price-low">Price: Low to High</option>')
      expect(sortSelect).toContainHTML('<option value="price-high">Price: High to Low</option>')
    })
  })
  ...
  describe('clear filters', () => {
    ...
    test('hides filter panel when clearing filters', () => {
      render(<FilterBar activeFiltersCount={1} onClearFilters={mockOnClearFilters} />)
  ...
  describe('helper functions', () => {
    ...
    test('getResultsText returns correct text for different counts', () => {
      ...
      expect(screen.getByText('25 results · Price: Low to High')).toBeInTheDocument()
    })
  })
  ...
  describe('edge cases', () => {
    ...
    test('handles very large itemCount', () => {
      ...
      expect(screen.getByText('9999 results · Newest First')).toBeInTheDocument()
    })
  })
