...
describe('About Page', () => {
  ...
  describe('Page Structure', () => {
    ...
    it('should display the main heading', () => {
      ...
      const mainHeading = screen.getByRole('heading', { level: 1, name: 'About TinyThreads' });
    ...
    it('should display Our Story section', () => {
      ...
      expect(screen.getByText(/A warm community where parents share/)).toBeInTheDocument();
    });
  });
  ...
  describe('Beliefs Section', () => {
    it('should render What We Believe In section', () => {
      ...
      expect(screen.getByRole('heading', { level: 2, name: 'What We Believe In' })).toBeInTheDocument();
    });
    ...
    it('should display belief descriptions', () => {
      ...
      expect(screen.getByText(/Every item gets a small gift of care/)).toBeInTheDocument();
      expect(screen.getByText(/We ensure high safety standards/)).toBeInTheDocument();
      expect(screen.getByText(/Quality baby items shouldn't cost a fortune/)).toBeInTheDocument();
    });
  });
  ...
  describe('Hello Section', () => {
    it('should render Say Hello section', () => {
      ...
      expect(screen.getByRole('heading', { level: 2, name: 'Say Hello' })).toBeInTheDocument();
    });

    it('should display hello message', () => {
      render(<AboutPage />);
      
      expect(screen.getByText(/We are just software engineers/)).toBeInTheDocument();
    });
  });
  ...
  describe('Team Section', () => {
    it('should render The Team section', () => {
      ...
      expect(screen.getByRole('heading', { level: 2, name: 'The Team Behind TinyThreads' })).toBeInTheDocument();
    });
    ...
    it('should display team member descriptions', () => {
      ...
      expect(screen.getByText(/Full-stack engineer focused on backend infrastructure/)).toBeInTheDocument();
      expect(screen.getByText(/Backend specialist working on database design/)).toBeInTheDocument();
      expect(screen.getByText(/Frontend engineer creating intuitive user interfaces/)).toBeInTheDocument();
    });
