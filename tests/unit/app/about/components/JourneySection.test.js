...
describe('JourneySection Component', () => {
  ...
  it('should display the problem statement', () => {
    ...
    expect(
      screen.getByText(/parents waste hundreds of dollars annually/),
    ).toBeInTheDocument();
  });
  ...
  it('should display the solution', () => {
    ...
    expect(
      screen.getByText(
        /What if technology could make selling baby items 10x faster/,
      ),
    ).toBeInTheDocument();
  });
  ...
  it('should display the mission', () => {
    ...
    expect(
      screen.getByText(/making parenting more affordable and sustainable/),
    ).toBeInTheDocument();
  });
