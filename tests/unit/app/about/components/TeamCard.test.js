...
describe('TeamCard Component', () => {
  ...
  it('should display team member name as h3', () => {
    ...
    const name = screen.getByRole('heading', { level: 3, name: 'Vinal Dalcy Dsouza' });
  ...
  it('should display team member image', () => {
    ...
    const image = screen.getByAltText('Vinal Dalcy Dsouza, Software Development Engineer');
  ...
  it('should render with different team member data', () => {
    ...
    expect(screen.getByText('Creates beautiful user interfaces.')).toBeInTheDocument();
  });
